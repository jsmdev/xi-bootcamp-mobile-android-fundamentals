...
import io.keepcoding.eh_ho.post.PostsViewModel
...
object DIProvider {
    ...
    val postsViewModelProviderFactory: PostsViewModel.PostsViewModelProviderFactory by lazy {
        PostsViewModel.PostsViewModelProviderFactory(
            repository
        )
    }
